...
RUN mkdir -p /usr/src/eswatini_geonode
...
COPY src /usr/src/eswatini_geonode/
WORKDIR /usr/src/eswatini_geonode
...
RUN chmod +x /usr/src/eswatini_geonode/tasks.py \
    && chmod +x /usr/src/eswatini_geonode/entrypoint.sh
...
# ENTRYPOINT /usr/src/eswatini_geonode/entrypoint.sh
