...
echo "-----------------------------------------------------"
echo "STARTING eswatini_geonode RESTORE $(date)"
echo "-----------------------------------------------------"
...
SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./eswatini_geonode/br/backup.sh $BKP_FOLDER_NAME/$NEW_UUID
...
echo "-----------------------------------------------------"
echo " - Original Backup of $TARGET_URL --> /$BKP_FOLDER_NAME/$NEW_UUID/"
echo "FINISHED eswatini_geonode RESTORE $(date)"
echo "-----------------------------------------------------"
