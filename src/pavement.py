...
try:
    from eswatini_geonode.local_settings import *
except ImportError:
    from eswatini_geonode.settings import *
...
def _reset():
    ...
    sh(f"rm -rf {path}")
    sh("rm -rf eswatini_geonode/development.db")
    sh("rm -rf eswatini_geonode/uploaded/*")
    _configure_data_dir()
